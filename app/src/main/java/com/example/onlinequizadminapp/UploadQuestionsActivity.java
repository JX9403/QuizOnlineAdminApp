...
import com.example.onlinequizadminapp.databinding.ActivityUploadQuestionsBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnUploadQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (correct == -1){
                    Toast.makeText(UploadQuestionsActivity.this, "Select Correct Answer", Toast.LENGTH_SHORT).show();
                    return;
                }
